...
// Query dengan search (hanya admin & dosen)
...
<div class="page-header">
    ...
    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
        <form method="GET" style="display: flex; gap: 5px;">
            ...
            <?php if(!empty($search)): ?>
                <a href="index.php" class="btn-outline" style="padding: 8px 16px;">
...
<div class="card-modern">
    <table class="table-modern">
        ...
        <tbody>
            <?php if(mysqli_num_rows($users) > 0): ?>
                ...
                <tr>
                    ...
                    <td>
                     ...
                     ﹏
                    <td><?= htmlspecialchars($user['email']) ?> ﹏
                    <td><?= htmlspecialchars($user['nim_nip']) ?> ﹏
                    <td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="6" style="text-align:center">Belum ada data user ﹏
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
    <div class="alert info" style="margin-top:16px">
        <i class="fas fa-info-circle"></i> Mahasiswa tidak ditampilkan di sini. Gunakan menu Laporan Nilai untuk melihat data mahasiswa.
    </div>
</div>
