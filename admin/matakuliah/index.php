...
<div class="page-header">
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <a href="<?= BASE_URL ?>/admin/matakuliah/tambah.php" class="btn-primary"><i class="fas fa-plus"></i> Tambah MK ke Kelas</a>
    </div>
</div>
...
<div class="card-modern">
    <table class="table-modern">
        <thead>
            <tr><th>Kode MK</th><th>Nama MK</th><th>Kelas</th><th>Dosen</th><th>Durasi</th><th>Mode</th><th>Aksi</th></tr>
        </thead>
        <tbody>
            <?php if(mysqli_num_rows($mk) > 0): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= BASE_URL ?>/admin/matakuliah/edit.php?id=<?= $row['id'] ?>" class="btn-primary" style="padding:4px 10px;font-size:12px;">Edit</a>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <tr><td colspan="7" style="text-align:center">Belum ada data mata kuliah per kelas</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
</div>
