...
<div class="card-modern" style="margin-bottom: 20px;">
    <form method="GET" class="form-filter" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: flex-end;">
        ...
        <div style="display: flex; gap: 10px;">
            ...
            <a href="nilai_all.php" class="btn-outline"><i class="fas fa-times"></i> Reset</a>
        </div>
    </form>
</div>
...
<div class="card-modern">
    <table class="table-modern">
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="7" style="text-align:center">Belum ada data ujian </td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
    ...
    <div style="margin-top: 20px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div>
            <a href="export_excel.php?<?= http_build_query($_GET) ?>" class="btn-success" style="background:#10b981; color:white; padding:10px 20px; border-radius:12px; text-decoration:none;">
