<?php
// admin/soal/index.php
// ======================================================
// LIHAT SEMUA SOAL DARI SEMUA DOSEN
// ======================================================
...
<div class="page-header">
    ...
    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
        <form method="GET" style="display: flex; gap: 5px;">
            <input type="text" name="search" class="form-control" placeholder="Cari kode MK, nama MK, teks soal..." 
                   value="<?= htmlspecialchars($search) ?>" style="width: 350px;">
...
<?php if(!empty($search) && mysqli_num_rows($soal) == 0): ?>
    <div class="alert info">Tidak ada soal yang cocok dengan "<?= htmlspecialchars($search) ?>"</div>
<?php endif; ?>
...
<div class="card-modern" style="overflow-x: auto;">
    <table class="table-modern" style="min-width: 800px;">
        ...
        <tbody>
            <?php if(mysqli_num_rows($soal) > 0): ?>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <strong><?= htmlspecialchars($row['mk_induk_kode']) ?></strong><br>
                        <small><?= htmlspecialchars(substr($row['mk_induk_nama'], 0, 30)) ?>...</small>
                    </td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align:center">Belum ada data soal</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
