...
<div class="page-header">
    ...
    <p class="page-subtitle">Selamat datang, <?= $_SESSION['nama'] ?>! Anda memiliki akses penuh ke seluruh sistem.</p>
</div>

<div class="dashboard-grid">
    <div class="stat-card"><div class="stat-info"><h3><?= $total_admin_dosen ?></h3><p>Admin & Dosen</p></div><div class="stat-icon"><i class="fas fa-users"></i></div></div>
    <div class="stat-card"><div class="stat-info"><h3><?= $total_mahasiswa ?></h3><p>Mahasiswa</p></div><div class="stat-icon"><i class="fas fa-user-graduate"></i></div></div>
    <div class="stat-card"><div class="stat-info"><h3><?= $total_kelas ?></h3><p>Kelas</p></div><div class="stat-icon"><i class="fas fa-school"></i></div></div>
    <div class="stat-card"><div class="stat-info"><h3><?= $total_mk ?></h3><p>Mata Kuliah</p></div><div class="stat-icon"><i class="fas fa-book"></i></div></div>
    <div class="stat-card"><div class="stat-info"><h3><?= $total_soal ?></h3><p>Total Soal</p></div><div class="stat-icon"><i class="fas fa-question-circle"></i></div></div>
</div>
...
<div class="menu-grid">
    <div class="card-modern">
        ...
        <a href="<?= BASE_URL ?>/admin/users/index.php" class="btn-primary">Kelola →</a>
    </div>
    <div class="card-modern">
        ...
        <a href="<?= BASE_URL ?>/admin/reset_password/index.php" class="btn-primary">Reset →</a>
    </div>
    <div class="card-modern">
        ...
        <a href="<?= BASE_URL ?>/admin/kelas/index.php" class="btn-primary">Kelola →</a>
    </div>
    <div class="card-modern">
        ...
        <a href="<?= BASE_URL ?>/admin/matakuliah/index.php" class="btn-primary">Kelola →</a>
    </div>
    <div class="card-modern">
        ...
        <a href="<?= BASE_URL ?>/admin/soal/index.php" class="btn-primary">Lihat →</a>
    </div>
    <div class="card-modern">
        ...
        <a href="<?= BASE_URL ?>/admin/laporan/nilai_all.php" class="btn-primary">Lihat →</a>
    </div>
</div>
