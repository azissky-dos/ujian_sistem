...
<head>
    ...
    <!-- CSS Internal - PASTE semua isi style.css di sini -->
    <style>
        /* PASTE SEMUA ISI FILE style.css ANDA DI SINI */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar { position: fixed; left: 0; top: 0; width: 280px; height: 100vh; background: rgba(15, 23, 42, 0.95); backdrop-filter: blur(10px); border-right: 1px solid rgba(255,255,255,0.1); display: flex; flex-direction: column; z-index: 100; }
        ...
        .nav-item { display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: rgba(255,255,255,0.7); text-decoration: none; transition: all 0.3s ease; margin: 4px 12px; border-radius: 12px; }
        ...
        .user-info { display: flex; align-items: center; gap: 12px; padding: 12px; background: rgba(255,255,255,0.05); border-radius: 12px; margin-bottom: 12px; }
        ...
        .logout-btn { display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: rgba(239,68,68,0.2); color: #f87171; text-decoration: none; border-radius: 10px; transition: all 0.3s ease; }
        ...
        .content-container { padding: 30px; background: linear-gradient(135deg, #f5f7fa 0%, #eef2f7 100%); min-height: 100vh; }

        .card-modern { background: white; border-radius: 24px; padding: 24px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.05), 0 8px 10px -6px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease; }
        .card-modern:hover { transform: translateY(-2px); box-shadow: 0 20px 25px -12px rgba(0,0,0,0.1); }

        .btn-primary { background: linear-gradient(135deg, #6366f1, #4f46e5); border: none; padding: 10px 20px; border-radius: 12px; color: white; font-weight: 600; cursor: pointer; transition: all 0.3s ease; text-decoration: none; display: inline-block; }
        .btn-primary:hover { transform: scale(1.02); box-shadow: 0 10px 20px -5px rgba(99,102,241,0.4); }

        .btn-outline { background: transparent; border: 2px solid #6366f1; color: #4f46e5; padding: 8px 18px; border-radius: 12px; text-decoration: none; display: inline-block; }
        ...
        .table-modern { width: 100%; background: white; border-radius: 20px; overflow: hidden; border-collapse: separate; border-spacing: 0; }
        .table-modern thead tr { background: linear-gradient(135deg, #1e293b, #0f172a); color: white; }
        .table-modern th { padding: 15px 20px; font-weight: 600; text-align: left; }
        .table-modern td { padding: 12px 20px; border-bottom: 1px solid #e2e8f0; }
        ...
        .stat-card { background: white; border-radius: 24px; padding: 24px; display: flex; align-items: center; justify-content: space-between; }
        .stat-icon { width: 60px; height: 60px; background: linear-gradient(135deg, #e0e7ff, #c7d2fe); border-radius: 20px; display: flex; align-items: center; justify-content: center; }
        ...
        .ujian-header { background: linear-gradient(135deg, #1e293b, #0f172a); border-radius: 20px; padding: 20px 24px; margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; color: white; flex-wrap: wrap; gap: 10px; }
        .timer-box { background: rgba(255,255,255,0.1); padding: 10px 20px; border-radius: 40px; font-family: monospace; font-size: 24px; font-weight: 700; }
        .warning-box { background: rgba(245,158,11,0.2); padding: 8px 16px; border-radius: 40px; color: #fbbf24; font-size: 14px; }

        .soal-card { background: white; border-radius: 20px; padding: 24px; margin-bottom: 20px; }
        .soal-number { background: #4f46e5; color: white; width: 32px; height: 32px; border-radius: 10px; display: inline-flex; align-items: center; justify-content: center; font-weight: 700; margin-right: 12px; }
        .radio-group { margin: 12px 0 0 20px; }
        .radio-group label { margin-left: 8px; margin-right: 20px; cursor: pointer; }
        ...
        @media (max-width: 768px) {
            ...
            .table-modern th, .table-modern td { padding: 8px 12px; }
        }
    </style>
</head>
<body>
